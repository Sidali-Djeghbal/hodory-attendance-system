...
- `Hodory-admin-electron/` — Admin desktop app (Electron wrapper)
- `Hodory-teacher/` — Teacher frontend
- `Hodory-teacher-electron/` — Teacher desktop app (Electron wrapper)
